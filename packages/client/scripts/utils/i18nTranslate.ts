...
function flattenObject(obj: NestedObject, prefix = ''): JsonObject {
...
function unflattenObject(obj: JsonObject) {
...
function googleTranslator(text: string, translateOptions: TranslateOptions) {
  return translate(text, translateOptions)
}
